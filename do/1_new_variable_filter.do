...
gen lost = 1 if year - age >= 1890 & year - age <= 1909
gen greatest = 1 if year - age >= 1910 & year - age <= 1927
gen silent = 1 if year - age >= 1928 & year - age <= 1945
gen boomers = 1 if year - age >= 1946 & year - age <= 1964
gen genx = 1 if year - age >= 1965 & year - age <= 1980
gen millen = 1 if year - age >= 1981 & year - age <= 1996 
gen genz = 1 if year - age >= 1997 & year - age <= 2012 
